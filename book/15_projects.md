...
A strong project does not need to be a highly complex masterpiece. A truly strong project asks clear research questions, follows a logical workflow, and communicates the solutions in a transparent, reproducible way. 
```
...
```{admonition} The Full Package
:class: note

Your goal is not to produce a flawless, commercial-grade software package. The objective is to demonstrate that you can design, implement, explain, and critically reflect on a reproducible solution to a real-world spatial data problem.
```
...
Do not wait until your code is "perfect" before writing your documentation or organizing your repository. The best projects are built iteratively: code a little, clean a little, document a little, and reflect often.
```

```{admonition} Suggested workflow
:class: dropdown

A highly effective way to manage your time is to break the project into small, actionable steps:

1. Choose a topic you genuinely understand and find engaging.
2. Define concrete, answerable research questions.
3. Load and inspect the raw data to understand its limitations.
4. Build a basic, "ugly" first version that successfully runs from start to finish.
5. Refactor your code to improve structure, readability, and reproducibility.
6. Interpret your results and generate your final visualizations.
7. Draft your report and presentation based on your finalized workflow.
```
...
You will select your project from a set of predefined [topics](https://hendrikwulf.github.io/sds210-jb/book/projects/topics). Each topic is anchored in open data and addresses a real spatial question. This provides you with a solid foundation to get started while leaving ample room for your own analytical decisions and creative problem-solving.
